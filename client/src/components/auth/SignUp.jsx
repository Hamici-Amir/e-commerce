...
export const SignUp = (  ) => {
  const [name, setName] = useState("");
    ...
    return (
      <div className=" h-[550px] w-[430px] ">
       
      <form onSubmit={handleSiqnUp} >
  ...
  >  						{isLoading ? <Loader className=' animate-spin mx-auto' size={24} /> : "Create Acount"}
 </button>
</form>
  ...
  <h1  className="" >  Already have an account ? </h1> 
      <Link to={"/sign-in"} 
       className="text-orange-700 cursor-pointer"> Sign In  </Link>
  </div>
