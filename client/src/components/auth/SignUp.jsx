...
export const SignUp = () => {
    ...
    return (
      <dialog id="my_modal_2" className="modal flex justify-center items-center">
      <div className="modal-box h-[550px] w-[430px] ">
        <form method="dialog">
  ...
  <span onClick={()=>document.getElementById(' my_modal_1 ').showModal() } className="text-orange-700 cursor-pointer"> Sign In  </span>
  </div>
